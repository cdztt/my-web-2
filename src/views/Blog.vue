...
watchEffect(() => currentSubjectName.value = route.params.subjectName ?? firstSubjectName.value);
...
<template>
    <div class="blog">
        ...
        <div class="blog-sider">
            <div v-for="[name, count] of subjects"
                :key="name"
                class="blog-subjects"
            >
                <span :class="['blog-subjects-name', {'blog-subjects-name-selected': currentSubjectName === name}]"
